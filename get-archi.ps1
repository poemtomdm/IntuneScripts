...
$procscript = Invoke-MgGraphRequest -Uri 'https://graph.microsoft.com/beta/deviceManagement/deviceManagementScripts/IDOFCUSTOMATTRIBUTES/deviceRunStates?$expand=managedDevice'
